...
| --- | --- | --- |
| One stable structure across themes | Header, eight-route strip, content region, and mobile dock are identical in dark and light modes | Theme toggle exercised in Obsidian; both states visually inspected |
...
| Dense operational rows instead of decorative bento cards | Programs, files, people, bookmarks, queues, and tasks use compact actionable rows | All eight routes exercised with live data |
...
| Responsive 2×2 signal/capture grids | Container queries respond to the dashboard pane, not only the window; mobile adds a five-action dock | Computed-width checks at desktop, narrow pane, and 390px viewport |
