...
export const FJG_AUTOMATION_ALLOWLIST: readonly AutomationDefinition[] = [
  {
    id: "vault-folder-processing",
    label: "Vault Folder Processing",
    description: "Organizes eligible loose files into existing managed vault folders.",
    group: "routine-vault",
    schedule: "Daily at 6:10 PM Pacific",
    manualPolicy: "routine",
    launchdLabel: "com.franklingarrett.vault-folder-process",
  ...
  },
  {
    ...
    description: "Files locally available Mira email notes by program or administrative subject.",
    group: "routine-vault",
    schedule: "Daily at 6:10 PM Pacific",
    manualPolicy: "routine",
    launchdLabel: "com.franklingarrett.mira-email-sort",
  ...
  {
    id: "formatted-notes-filing",
    label: "Formatted Notes Filing",
    description: "Files completed notes into their approved vault destinations.",
    group: "routine-vault",
    schedule: "Daily at 6:10 PM Pacific",
    manualPolicy: "routine",
    launchdLabel: "com.franklingarrett.formatted-notes-file",
    expectedState: "configured",
  },
  {
    id: "thought-capture-organizing",
    label: "Thought Capture Organizing",
    description: "Organizes queued entries within the six Thought Capture category notes.",
    group: "routine-vault",
    schedule: "Daily at 6:10 PM Pacific",
    manualPolicy: "routine",
    launchdLabel: "com.franklingarrett.thought-capture-organize",
    expectedState: "configured",
  },
  {
    id: "vocci-notes-processing",
    label: "Vocci Notes Processing",
    description: "The active Codex scheduler manages this cloud-connected workflow; no safe local launchd action exists.",
    group: "routine-vault",
    schedule: "Daily at 6:10 PM Pacific",
  ...
  },
  {
    ...
    description: "Installed but intentionally disabled and not loaded; enable it outside this dashboard before it can run.",
    group: "services-sync",
    schedule: "Disabled",
  ...
  },
  {
    ...
    label: "iOS Repository Auto-Sync",
    description: "Fast-forwards, commits, and pushes configured iOS repositories; manual execution remains intentionally blocked.",
    group: "services-sync",
    schedule: "At login, then every 60 seconds",
  ...
  },
  {
    ...
    label: "Plugin Repository Auto-Sync",
    description: "Keeps plugin source repositories synchronized with GitHub; manual execution remains intentionally blocked.",
    group: "services-sync",
    schedule: "At login, then every 60 seconds",
    manualPolicy: "high-impact",
  ...
  },
  {
    ...
    label: "FJG Mail Local Exporter",
    description: "Exports configured Outlook messages into the Mira email intake; manual execution is not a safe standalone action.",
    group: "services-sync",
    schedule: "At login, then every 60 seconds",
  ...
  {
    id: "mira-local-sync",
    label: "Mira Email Local Sync",
    description: "Synchronizes the locally available Mira email notes and attachments; shown for status only.",
    group: "services-sync",
  ...
  {
    id: "outlook-exporter",
    label: "Agent Mission Control Telegram Bot",
    description: "Persistent Telegram routing service; it already runs continuously and has no manual job action.",
    group: "services-sync",
  ...
  {
    id: "franklin-ai-gateway",
    label: "Franklin AI Gateway",
    description: "Persistent Messages command gateway; it already runs continuously and has no manual job action.",
    group: "services-sync",
    schedule: "Continuous service",
    manualPolicy: "service",
    expectedState: "configured",
  ...
  {
    id: "vault-automation-runner",
    label: "FJG Vault Automation Runner",
    description: "Persistent broker poller; it already runs continuously and is not itself a processor.",
    group: "services-sync",
    schedule: "Continuous service",
    manualPolicy: "service",
    launchdLabel: "com.fjg.vault-automation-runner",
    expectedState: "configured",
  },
  {
    id: "vault-automation-executor",
    label: "FJG Vault Automation Executor",
    description: "Loaded sentinel that gates the fixed remote controls; it has no independent manual action.",
    group: "services-sync",
    schedule: "Login sentinel",
    manualPolicy: "service",
    launchdLabel: "com.fjg.vault-automation-executor",
    expectedState: "configured",
  },
] as const;
