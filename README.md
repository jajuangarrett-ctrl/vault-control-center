...
| Automations | A fixed safety-reviewed inventory of scheduled processors, services, repository sync, and external jobs, plus executor-Mac RAM status |
